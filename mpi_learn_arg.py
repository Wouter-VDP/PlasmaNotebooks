...
# Load confuguration and safe it:
conf_name = sys.argv[1]
conf_file_in = "/home/wvdp/PPPLDeepLearning/slurm/MyConfigurations/" + conf_name + ".yaml"
conf_file_out = "/tmp/conf.yaml"
copyfile(conf_file_in, conf_file_out)
...
print('Wouter', conf['paths']['specific_signals'])
print('Wouter', conf['training']['num_epochs'])
